import { dashboardDataFetching } from '@/lib/admin/actions/dashboardDataFetch';
import React from 'react'
import DashboardWidget from './DashboardWidget';

const AdminDashboard = async() => {
    const { bookingReq, ruqqyaReq, hizamaReq, ruqyyaCom, hizamaCom } =
    await dashboardDataFetching();
